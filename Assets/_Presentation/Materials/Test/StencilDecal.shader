Shader "Unlit/StencilDecal"
{
    ...
    SubShader
    {
        ...
        float GetFinalDistortion(float2 uvProj, float shapeTex)
        {
            ...
            float4 final = tex2D(_MovingTex, movingUV).r;
        ...
        float3 ReconstructObjectPosition(float3 positionHCS)
        {
            ...
            half4 fragStencilMask(Varyings IN) : SV_Target{
                ...
                float3 opos = ReconstructObjectPosition(IN.positionHCS);
